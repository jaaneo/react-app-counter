...
function App() {
  ...
  return (  
    <div class="bg-gradient-to-r from-sky-500 to-indigo-500 p-4">
           ...
           <p class="p-4">
            <ButtonIncrement text="Increment" onClick={handleIncrement} />
            <ButtonDecrement text="Decrement" onClick={handleDecrement} />
           </p>        
    </div>  
  );
}
